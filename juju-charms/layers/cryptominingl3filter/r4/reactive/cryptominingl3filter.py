...
status_file = "cryptominingl3filter_status.log"


@when_not('cryptominingl3filter.configured')
def not_configured():
...
def config_changed():
    try:
        ...
        set_flag("cryptominingl3filter.configured")
...
@when('cryptominingl3filter.configured')
@when('actions.start')
def start():
